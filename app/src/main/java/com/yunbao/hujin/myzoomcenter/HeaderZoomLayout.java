...
/**
 * 自定义阻尼式 View on 2017/10/26.
 * 若继承自 ScrollView 则 仅 头布局 可以阻尼
 */

public class HeaderZoomLayout extends NestedScrollView{

    private View mHeaderView;

    private int mHeaderWidth;
    private int mHeaderHeight;
    private boolean mIsPulling;     //是否正在下拉
    private int mLastY;

    private float mScaleRatio = 0.4f;   //滑动放大系数，系数越大，滑动时放大程度越大
    private float mScaleTimes = 2f;     //最大的放大倍数
    private float mReplyRatio = 0.5f;   //回弹时间系数，系数越小，回弹越快
